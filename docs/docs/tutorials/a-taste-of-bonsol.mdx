...
Get the latest version of anchor using `avm` and ensure you are using the correct version of rust and solana. At the time of writing this tutorial the version of anchor is 0.30.1, the recommended rust version is 1.79.0 and the solana version is 1.18.17.
<Prereq />
